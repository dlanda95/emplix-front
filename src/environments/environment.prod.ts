...
export const environment = {
  ...
  redirectUri: 'https://ambitious-glacier-018d9ed0f.7.azurestaticapps.net/',
  azure: {
    // App Registration de PRODUCCIÓN en portal.azure.com (diferente al de DEV)
    clientId: '40fdfa96-fd34-4c7e-82b0-905097c87714',
    popupRedirectUri: 'https://ambitious-glacier-018d9ed0f.7.azurestaticapps.net/auth-redirect.html',
  },
};
